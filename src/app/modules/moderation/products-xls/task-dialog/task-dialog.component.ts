...
export class TaskDialogComponent implements OnInit, OnDestroy {
  ...
  private getTypeObject(type: number) {
    switch (type) {
      ...
      case FEED_PROCESS_TYPES.VALUES_STAT_XLS:
        return 'Статистика XLS фида по значениям';
      case FEED_PROCESS_TYPES.PARSE_RAW_PRODUCTS_XLS:
        return 'Парсинг сырых продуктов на основе схемы XLS';
      case FEED_PROCESS_TYPES.EXPORT_PRODUCTS_XLS:
        return 'Экспорт напаршенных продукт XLS';
    }
  }
