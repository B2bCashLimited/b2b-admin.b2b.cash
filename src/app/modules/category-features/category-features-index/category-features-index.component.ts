...
@ClearSubscriptions()
@Component({
  selector: 'b2b-category-features-index',
  templateUrl: './category-features-index.component.html',
  styleUrls: ['./category-features-index.component.scss']
})
export class CategoryFeaturesIndexComponent implements OnInit, OnDestroy {
